...
# Compile SAPP
	...
	chmod +x autogen.sh
	./autogen.sh
	./configure --prefix=$(pwd)/depends/x86_64-w64-mingw32 --disable-debug --disable-tests --disable-bench CPPFLAGS="-O3 --param ggc-min-expand=1 --param ggc-min-heapsize=32768" CXXFLAGS="-O3 --param ggc-min-expand=1 --param ggc-min-heapsize=32768"
	make -j$(echo $CPU_CORES) HOST=x86_64-w64-mingw32
	cd ..
